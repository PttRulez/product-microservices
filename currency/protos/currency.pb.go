...
type StreamingRateReponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	//
	//	*StreamingRateReponse_RateResponse
	//	*StreamingRateReponse_Error
	Message isStreamingRateReponse_Message `protobuf_oneof:"message"`
}

func (x *StreamingRateReponse) Reset() {
	*x = StreamingRateReponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *StreamingRateReponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StreamingRateReponse) ProtoMessage() {}

func (x *StreamingRateReponse) ProtoReflect() protoreflect.Message {
	mi := &file_currency_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StreamingRateReponse.ProtoReflect.Descriptor instead.
func (*StreamingRateReponse) Descriptor() ([]byte, []int) {
	return file_currency_proto_rawDescGZIP(), []int{2}
}

func (m *StreamingRateReponse) GetMessage() isStreamingRateReponse_Message {
	if m != nil {
		return m.Message
	}
	return nil
...
func (x *StreamingRateReponse) GetRateResponse() *RateResponse {
	if x, ok := x.GetMessage().(*StreamingRateReponse_RateResponse); ok {
		return x.RateResponse
	}
	return nil
}

func (x *StreamingRateReponse) GetError() *status.Status {
	if x, ok := x.GetMessage().(*StreamingRateReponse_Error); ok {
		return x.Error
	}
	return nil
}

type isStreamingRateReponse_Message interface {
	isStreamingRateReponse_Message()
}

type StreamingRateReponse_RateResponse struct {
	RateResponse *RateResponse `protobuf:"bytes,1,opt,name=rate_response,json=rateResponse,proto3,oneof"`
}

type StreamingRateReponse_Error struct {
	Error *status.Status `protobuf:"bytes,2,opt,name=error,proto3,oneof"`
}

func (*StreamingRateReponse_RateResponse) isStreamingRateReponse_Message() {}

func (*StreamingRateReponse_Error) isStreamingRateReponse_Message() {}
...
var file_currency_proto_rawDesc = []byte{
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x01, 0x52, 0x04, 0x52, 0x61, 0x74, 0x65, 0x22, 0x83, 0x01, 0x0a,
	0x14, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67, 0x52, 0x61, 0x74, 0x65, 0x52, 0x65,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x34, 0x0a, 0x0d, 0x72, 0x61, 0x74, 0x65, 0x5f, 0x72, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x52,
	0x61, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x48, 0x00, 0x52, 0x0c, 0x72,
	0x61, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2a, 0x0a, 0x05, 0x65,
	...
	0x67, 0x65, 0x2a, 0xb5, 0x02, 0x0a, 0x0a, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x69, 0x65,
	...
	0x1f, 0x12, 0x07, 0x0a, 0x03, 0x5a, 0x41, 0x52, 0x10, 0x20, 0x32, 0x6d, 0x0a, 0x08, 0x43, 0x75,
	...
	0x0d, 0x2e, 0x52, 0x61, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x39,
	0x0a, 0x0e, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x52, 0x61, 0x74, 0x65, 0x73,
	0x12, 0x0c, 0x2e, 0x52, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x15,
	0x2e, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67, 0x52, 0x61, 0x74, 0x65, 0x52, 0x65,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x28, 0x01, 0x30, 0x01, 0x42, 0x09, 0x5a, 0x07, 0x2f, 0x70, 0x72,
...
var file_currency_proto_goTypes = []interface{}{
	...
	(*StreamingRateReponse)(nil), // 3: StreamingRateReponse
...
var file_currency_proto_depIdxs = []int32{
	...
	2, // 4: StreamingRateReponse.rate_response:type_name -> RateResponse
	4, // 5: StreamingRateReponse.error:type_name -> google.rpc.Status
	...
	3, // 9: Currency.SubscribeRates:output_type -> StreamingRateReponse
...
func file_currency_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_currency_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StreamingRateReponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_currency_proto_msgTypes[2].OneofWrappers = []interface{}{
		(*StreamingRateReponse_RateResponse)(nil),
		(*StreamingRateReponse_Error)(nil),
	}
	type x struct{}
